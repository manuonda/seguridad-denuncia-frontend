          ...
          <div class="presentacion">
            <div>
              ...
              <p class="intro sombra ng-binding">
                Si tenes conocimiento de quien vende <strong>Drogas</strong>,
                quien vende bebidas alcohólicas fuera del horario permitido o a
                menores de edad, lugares funcionando como
                <strong>After Clandestinos</strong>, junta de personas en
                lugares públicos para <strong>Consumir Drogas</strong> y
                <strong>Otros Delitos</strong> que te preocupan.<br />
                <br />
                Brindanos información de manera fácil, rápida y segura.
                <br /><br />
                <span style="font-family:'dinBold'" class="ng-binding"
                  >La seguridad la hacemos entre todos</span
                >
                <br /><br />
                <button
                  type="button"
                  class="btn btn-lg btn-action ng-binding"
